 ...
 * @author gwenz1
 */
public class ScoreHashBean {
    // instance variables
    private Map<String, User> scoreHash;
    private User user;
    private String userName;
    String str;
    String strArray[];
    private String file = "E:/IT_Programmer_Analyst/3rd_Semester/Java_Web/Final/ReflexGame/build/web/files/score.txt";
     ...
     * called user.txt
     */
    public ScoreHashBean() {
        // instantiate the HashMap object in memory
        scoreHash = new HashMap<String, User>();
        ...
        try {
            ...
            while (br.ready()) { // while there is data in the Buffered Reader...
                ...
                scoreHash.put(strArray[0], new User(strArray[0], strArray[1])); // create a new user entry in the hashmap with
    ...
    public User getUser() {
        ...
        if (userName != null && scoreHash.containsKey(userName)) {
            user = scoreHash.get(userName);
    ...
    /**
     * Given us the set of titles of all the books in an Iterator.
     *
     * @return
     */
    public Iterator<String> getUserList() {

        return scoreHash.keySet().iterator();
    ...
    public static void main(String[] args) {
        ...
        if (userHashBean.isPopulated()) {
            ...
            System.err.println("The Score Hash Bean was not populated.");
        }
    }
}
